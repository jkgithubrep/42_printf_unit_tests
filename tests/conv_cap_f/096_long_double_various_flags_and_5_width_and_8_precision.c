...
# define ARGS "%5.8LF|%-5.8LF|%+5.8LF|% 5.8LF|%#5.8LF|%05.8LF", 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L

int		conv_cap_f_long_double_various_flags_and_5_width_and_8_precision(void)
{
