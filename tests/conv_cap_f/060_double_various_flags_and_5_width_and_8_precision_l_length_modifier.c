...
# define ARGS "%5.8lF|%-5.8lF|%+5.8lF|% 5.8lF|%#5.8lF|%05.8lF", 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849

int		conv_cap_f_double_various_flags_and_5_width_and_8_precision_l_length_modifier(void)
{
