...
# define ARGS "%.lF|%-.lF|%+.lF|% .lF|%#.lF|%0.lF", 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849

int		conv_cap_f_double_various_flags_and_dot_precision_l_length_modifier(void)
{
