...
# define ARGS "%1LF|%-1LF|%+1LF|% 1LF|%#1LF|%01LF", 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L

int		conv_cap_f_long_double_various_flags_and_1_width(void)
{
