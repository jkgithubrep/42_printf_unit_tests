...
# define ARGS "%5LF|%-5LF|%+5LF|% 5LF|%#5LF|%05LF", 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L

int		conv_cap_f_long_double_various_flags_and_5_width(void)
{
