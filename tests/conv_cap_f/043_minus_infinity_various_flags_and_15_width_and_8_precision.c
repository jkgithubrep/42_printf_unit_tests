...
# define ARGS "%15.8F|%-15.8F|%+15.8F|% 15.8F|%#15.8F|%015.8F", -INFINITY, -INFINITY, -INFINITY, -INFINITY, -INFINITY, -INFINITY

int		conv_cap_f_minus_infinity_various_flags_and_15_width_and_8_precision(void)
{
