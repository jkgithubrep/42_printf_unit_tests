...
# define ARGS "%.LF|%-.LF|%+.LF|% .LF|%#.LF|%0.LF", 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L

int		conv_cap_f_long_double_various_flags_and_dot_precision(void)
{
