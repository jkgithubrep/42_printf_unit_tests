...
# define ARGS "%.8LF|%-.8LF|%+.8LF|% .8LF|%#.8LF|%0.8LF", 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L

int		conv_cap_f_long_double_various_flags_and_8_precision(void)
{
