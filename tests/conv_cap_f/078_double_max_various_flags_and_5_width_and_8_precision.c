...
# define ARGS "%5.8F|%-5.8F|%+5.8F|% 5.8F|%#5.8F|%05.8F", DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX

int		conv_cap_f_double_max_various_flags_and_5_width_and_8_precision(void)
{
