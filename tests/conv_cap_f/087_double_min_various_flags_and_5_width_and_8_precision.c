...
# define ARGS "%5.8F|%-5.8F|%+5.8F|% 5.8F|%#5.8F|%05.8F", DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN

int		conv_cap_f_double_min_various_flags_and_5_width_and_8_precision(void)
{
