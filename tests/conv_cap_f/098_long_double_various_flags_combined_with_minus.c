...
# define ARGS "%-+8.14LF|%- 8.14LF|%-#8.14LF|%-08.14LF|%-+#8.14LF|%-+ #08.14LF", 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L

int		conv_cap_f_long_double_various_flags_combined_with_minus(void)
{
