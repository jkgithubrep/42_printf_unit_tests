...
# define ARGS "%-+8.14F|%- 8.14F|%-#8.14F|%-08.14F|%-+#8.14F|%-+ #08.14F", DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN

int		conv_cap_f_double_min_various_flags_combined_with_minus(void)
{
