...
# define ARGS "%-+8.14F|%- 8.14F|%-#8.14F|%-08.14F|%-+#8.14F|%-+ #08.14F", -INFINITY, -INFINITY, -INFINITY, -INFINITY, -INFINITY, -INFINITY

int		conv_cap_f_minus_infinity_various_flags_combined_with_minus(void)
{
