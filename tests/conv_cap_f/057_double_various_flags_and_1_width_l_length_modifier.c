...
# define ARGS "%1lF|%-1lF|%+1lF|% 1lF|%#1lF|%01lF", 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849

int		conv_cap_f_double_various_flags_and_1_width_l_length_modifier(void)
{
