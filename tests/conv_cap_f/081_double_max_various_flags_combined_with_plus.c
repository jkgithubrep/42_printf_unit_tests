...
# define ARGS "%+8.14F|%+ 8.14F|%+-8.14F|%+#8.14F|%+08.14F|%+ -#08.14F", DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX

int		conv_cap_f_double_max_various_flags_combined_with_plus(void)
{
