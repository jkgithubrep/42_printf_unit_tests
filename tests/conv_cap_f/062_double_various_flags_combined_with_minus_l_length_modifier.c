...
# define ARGS "%-+8.14lF|%- 8.14lF|%-#8.14lF|%-08.14lF|%-+#8.14lF|%-+ #08.14lF", 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849

int		conv_cap_f_double_various_flags_combined_with_minus_l_length_modifier(void)
{
