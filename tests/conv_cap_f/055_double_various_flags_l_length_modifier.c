...
# define ARGS "%lF|%-lF|%+lF|% lF|%#lF|%0lF", 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849

int		conv_cap_f_double_various_flags_l_length_modifier(void)
{
