...
# define ARGS "%5.8F|%-5.8F|%+5.8F|% 5.8F|%#5.8F|%05.8F", -INFINITY, -INFINITY, -INFINITY, -INFINITY, -INFINITY, -INFINITY

int		conv_cap_f_minus_infinity_various_flags_and_5_width_and_8_precision(void)
{
