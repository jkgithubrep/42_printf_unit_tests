...
# define ARGS "%15.8F|%-15.8F|%+15.8F|% 15.8F|%#15.8F|%015.8F", DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX

int		conv_cap_f_double_max_various_flags_and_15_width_and_8_precision(void)
{
