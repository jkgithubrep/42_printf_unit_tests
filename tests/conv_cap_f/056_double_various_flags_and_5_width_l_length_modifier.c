...
# define ARGS "%5lF|%-5lF|%+5lF|% 5lF|%#5lF|%05lF", 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849

int		conv_cap_f_double_various_flags_and_5_width_l_length_modifier(void)
{
