...
# define ARGS "%.8lF|%-.8lF|%+.8lF|% .8lF|%#.8lF|%0.8lF", 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849

int		conv_cap_f_double_various_flags_and_8_precision_l_length_modifier(void)
{
