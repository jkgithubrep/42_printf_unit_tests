...
# define ARGS "%15.8F|%-15.8F|%+15.8F|% 15.8F|%#15.8F|%015.8F", DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN

int		conv_cap_f_double_min_various_flags_and_15_width_and_8_precision(void)
{
