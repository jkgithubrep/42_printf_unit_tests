...
# define ARGS "%.llX|%-.llX|%#.llX|%0.llX", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_cap_x_ullong_max_and_various_flags_and_dot_precision_ll_modifier(void)
{
