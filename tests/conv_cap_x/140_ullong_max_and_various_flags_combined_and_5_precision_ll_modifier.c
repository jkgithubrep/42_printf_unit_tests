...
# define ARGS "%-#.5llX|%-0.5llX|%#0.5llX|%-#0.5llX", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_cap_x_ullong_max_and_various_flags_combined_and_5_precision_ll_modifier(void)
{
