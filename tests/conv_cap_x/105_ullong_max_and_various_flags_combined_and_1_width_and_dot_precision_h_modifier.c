...
# define ARGS "%-#1.hX|%-01.hX|%#01.hX|%-#01.hX", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_cap_x_ullong_max_and_various_flags_combined_and_1_width_and_dot_precision_h_modifier(void)
{
