...
# define ARGS "%23.llX|%-23.llX|%#23.llX|%023.llX", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_cap_x_ullong_max_and_various_flags_and_23_width_and_dot_precision_ll_modifier(void)
{
