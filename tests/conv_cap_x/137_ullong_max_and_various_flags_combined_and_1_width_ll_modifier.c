...
# define ARGS "%-#1llX|%-01llX|%#01llX|%-#01llX", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_cap_x_ullong_max_and_various_flags_combined_and_1_width_ll_modifier(void)
{
