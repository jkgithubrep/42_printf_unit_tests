...
# define ARGS "%-#23lX|%-023lX|%#023lX|%-#023lX", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_cap_x_ullong_max_and_various_flags_combined_and_23_width_l_modifier(void)
{
