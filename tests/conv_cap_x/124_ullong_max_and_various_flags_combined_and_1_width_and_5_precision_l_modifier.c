...
# define ARGS "%-#1.5lX|%-01.5lX|%#01.5lX|%-#01.5lX", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_cap_x_ullong_max_and_various_flags_combined_and_1_width_and_5_precision_l_modifier(void)
{
