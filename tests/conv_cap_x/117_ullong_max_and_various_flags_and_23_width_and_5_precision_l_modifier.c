...
# define ARGS "%23.5lX|%-23.5lX|%#23.5lX|%023.5lX", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_cap_x_ullong_max_and_various_flags_and_23_width_and_5_precision_l_modifier(void)
{
