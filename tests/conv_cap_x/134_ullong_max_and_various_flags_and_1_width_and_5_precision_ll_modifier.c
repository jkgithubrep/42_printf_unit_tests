...
# define ARGS "%1.5llX|%-1.5llX|%#1.5llX|%01.5llX", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_cap_x_ullong_max_and_various_flags_and_1_width_and_5_precision_ll_modifier(void)
{
