...
# define ARGS "%-#23.5hX|%-023.5hX|%#023.5hX|%-#023.5hX", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_cap_x_ullong_max_and_various_flags_combined_and_23_width_and_5_precision_h_modifier(void)
{
