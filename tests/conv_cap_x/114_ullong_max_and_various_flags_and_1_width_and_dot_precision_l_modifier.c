...
# define ARGS "%1.lX|%-1.lX|%#1.lX|%01.lX", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_cap_x_ullong_max_and_various_flags_and_1_width_and_dot_precision_l_modifier(void)
{
