...
# define ARGS "%23.5llX|%-23.5llX|%#23.5llX|%023.5llX", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_cap_x_ullong_max_and_various_flags_and_23_width_and_5_precision_ll_modifier(void)
{
