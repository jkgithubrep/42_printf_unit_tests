...
# define ARGS "%23.lX|%-23.lX|%#23.lX|%023.lX", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_cap_x_ullong_max_and_various_flags_and_23_width_and_dot_precision_l_modifier(void)
{
