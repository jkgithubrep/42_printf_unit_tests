...
# define ARGS "%-#23.hX|%-023.hX|%#023.hX|%-#023.hX", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_cap_x_ullong_max_and_various_flags_combined_and_23_width_and_dot_precision_h_modifier(void)
{
