...
# define ARGS "%-#1.llX|%-01.llX|%#01.llX|%-#01.llX", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_cap_x_ullong_max_and_various_flags_combined_and_1_width_and_dot_precision_ll_modifier(void)
{
