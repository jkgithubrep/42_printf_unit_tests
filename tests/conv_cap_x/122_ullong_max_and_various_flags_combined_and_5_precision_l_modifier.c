...
# define ARGS "%-#.5lX|%-0.5lX|%#0.5lX|%-#0.5lX", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_cap_x_ullong_max_and_various_flags_combined_and_5_precision_l_modifier(void)
{
