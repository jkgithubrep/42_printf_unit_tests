...
# define ARGS "%-+.d|%- .d|%-0.d|%+ .d|%+0.d|% 0.d|%-+ 0.d", INT_MAX + 1, INT_MAX, INT_MAX + 1, INT_MAX, INT_MAX + 1, INT_MAX, INT_MAX + 1, INT_MAX, INT_MAX + 1, INT_MAX, INT_MAX + 1, INT_MAX, INT_MAX + 1, INT_MAX
