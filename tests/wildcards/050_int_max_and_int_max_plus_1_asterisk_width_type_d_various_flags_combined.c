...
# define ARGS "%-+d|%- d|%-0d|%+ d|%+0d|% 0d|%-+ 0d", INT_MAX + 1, INT_MAX, INT_MAX + 1, INT_MAX, INT_MAX + 1, INT_MAX, INT_MAX + 1, INT_MAX, INT_MAX + 1, INT_MAX, INT_MAX + 1, INT_MAX, INT_MAX + 1, INT_MAX
