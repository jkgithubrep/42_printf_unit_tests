...
# define ARGS "%-+.5d|%- .5d|%-0.5d|%+ .5d|%+0.5d|% 0.5d|%-+ 0.5d", INT_MAX + 1, INT_MAX, INT_MAX + 1, INT_MAX, INT_MAX + 1, INT_MAX, INT_MAX + 1, INT_MAX, INT_MAX + 1, INT_MAX, INT_MAX + 1, INT_MAX, INT_MAX + 1, INT_MAX
