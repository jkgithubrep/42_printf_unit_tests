...
# define ARGS "%23.x|%-23.x|%#23.x|%023.x", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_x_ullong_max_and_various_flags_and_23_width_and_dot_precision(void)
{
