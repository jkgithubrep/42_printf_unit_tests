...
# define ARGS "%-#1hhx|%-01hhx|%#01hhx|%-#01hhx", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_x_ullong_max_and_various_flags_combined_and_1_width_hh_modifier(void)
{
