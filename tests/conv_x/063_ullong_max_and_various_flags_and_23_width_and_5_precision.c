...
# define ARGS "%23.5x|%-23.5x|%#23.5x|%023.5x", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_x_ullong_max_and_various_flags_and_23_width_and_5_precision(void)
{
