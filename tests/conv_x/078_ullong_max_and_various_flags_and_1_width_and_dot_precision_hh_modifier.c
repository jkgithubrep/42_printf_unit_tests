...
# define ARGS "%1.hhx|%-1.hhx|%#1.hhx|%01.hhx", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_x_ullong_max_and_various_flags_and_1_width_and_dot_precision_hh_modifier(void)
{
