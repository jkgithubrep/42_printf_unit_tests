...
# define ARGS "%-#23.x|%-023.x|%#023.x|%-#023.x", UINT_MAX, UINT_MAX, UINT_MAX, UINT_MAX

int		conv_x_uint_max_and_various_flags_combined_and_23_width_and_dot_precision(void)
{
