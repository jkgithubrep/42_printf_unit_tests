...
# define ARGS "%1.hx|%-1.hx|%#1.hx|%01.hx", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_x_ullong_max_and_various_flags_and_1_width_and_dot_precision_h_modifier(void)
{
