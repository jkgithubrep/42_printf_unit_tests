...
# define ARGS "%-#23hhx|%-023hhx|%#023hhx|%-#023hhx", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_x_ullong_max_and_various_flags_combined_and_23_width_hh_modifier(void)
{
