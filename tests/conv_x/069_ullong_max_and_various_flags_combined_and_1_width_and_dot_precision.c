...
# define ARGS "%-#1.x|%-01.x|%#01.x|%-#01.x", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_x_ullong_max_and_various_flags_combined_and_1_width_and_dot_precision(void)
{
