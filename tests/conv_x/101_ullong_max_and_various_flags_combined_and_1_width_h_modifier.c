...
# define ARGS "%-#1hx|%-01hx|%#01hx|%-#01hx", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_x_ullong_max_and_various_flags_combined_and_1_width_h_modifier(void)
{
