...
# define ARGS "%-#1.x|%-01.x|%#01.x|%-#01.x", ULONG_MAX, ULONG_MAX, ULONG_MAX, ULONG_MAX

int		conv_x_ulong_max_and_various_flags_combined_and_1_width_and_dot_precision(void)
{
