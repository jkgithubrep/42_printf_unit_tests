...
# define ARGS "%-#1.5x|%-01.5x|%#01.5x|%-#01.5x", ULONG_MAX, ULONG_MAX, ULONG_MAX, ULONG_MAX

int		conv_x_ulong_max_and_various_flags_combined_and_1_width_and_5_precision(void)
{
