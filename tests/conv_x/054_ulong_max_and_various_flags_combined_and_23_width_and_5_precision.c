...
# define ARGS "%-#23.5x|%-023.5x|%#023.5x|%-#023.5x", ULONG_MAX, ULONG_MAX, ULONG_MAX, ULONG_MAX

int		conv_x_ulong_max_and_various_flags_combined_and_23_width_and_5_precision(void)
{
