...
# define ARGS "%-#.hhx|%-0.hhx|%#0.hhx|%-#0.hhx", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_x_ullong_max_and_various_flags_combined_and_dot_precision_hh_modifier(void)
{
