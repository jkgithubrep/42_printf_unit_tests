...
# define ARGS "%23.5hhx|%-23.5hhx|%#23.5hhx|%023.5hhx", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_x_ullong_max_and_various_flags_and_23_width_and_5_precision_hh_modifier(void)
{
