...
# define ARGS "%-#23.x|%-023.x|%#023.x|%-#023.x", ULONG_MAX, ULONG_MAX, ULONG_MAX, ULONG_MAX

int		conv_x_ulong_max_and_various_flags_combined_and_23_width_and_dot_precision(void)
{
