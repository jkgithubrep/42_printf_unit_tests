...
# define ARGS "%1.5hx|%-1.5hx|%#1.5hx|%01.5hx", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_x_ullong_max_and_various_flags_and_1_width_and_5_precision_h_modifier(void)
{
