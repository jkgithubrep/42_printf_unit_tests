...
# define ARGS "%-#23hx|%-023hx|%#023hx|%-#023hx", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_x_ullong_max_and_various_flags_combined_and_23_width_h_modifier(void)
{
