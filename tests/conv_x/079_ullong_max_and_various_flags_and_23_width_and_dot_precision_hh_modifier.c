...
# define ARGS "%23.hhx|%-23.hhx|%#23.hhx|%023.hhx", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_x_ullong_max_and_various_flags_and_23_width_and_dot_precision_hh_modifier(void)
{
