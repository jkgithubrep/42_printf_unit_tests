...
# define ARGS "%23.5hx|%-23.5hx|%#23.5hx|%023.5hx", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_x_ullong_max_and_various_flags_and_23_width_and_5_precision_h_modifier(void)
{
