...
# define ARGS "%-#1.5hhx|%-01.5hhx|%#01.5hhx|%-#01.5hhx", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_x_ullong_max_and_various_flags_combined_and_1_width_and_5_precision_hh_modifier(void)
{
