...
# define ARGS "%-#.hx|%-0.hx|%#0.hx|%-#0.hx", ULLONG_MAX, ULLONG_MAX, ULLONG_MAX, ULLONG_MAX

int		conv_x_ullong_max_and_various_flags_combined_and_dot_precision_h_modifier(void)
{
