...
# define ARGS "%5.8E|%-5.8E|%+5.8E|% 5.8E|%#5.8E|%05.8E", DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX

int		conv_cap_e_double_max_various_flags_and_5_width_and_8_precision(void)
{
