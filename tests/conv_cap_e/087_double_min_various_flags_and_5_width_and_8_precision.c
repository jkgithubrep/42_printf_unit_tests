...
# define ARGS "%5.8E|%-5.8E|%+5.8E|% 5.8E|%#5.8E|%05.8E", DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN

int		conv_cap_e_double_min_various_flags_and_5_width_and_8_precision(void)
{
