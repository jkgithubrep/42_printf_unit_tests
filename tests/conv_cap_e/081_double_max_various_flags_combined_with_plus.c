...
# define ARGS "%+8.14E|%+ 8.14E|%+-8.14E|%+#8.14E|%+08.14E|%+ -#08.14E", DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX

int		conv_cap_e_double_max_various_flags_combined_with_plus(void)
{
