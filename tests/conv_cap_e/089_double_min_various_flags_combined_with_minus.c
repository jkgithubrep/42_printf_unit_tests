...
# define ARGS "%-+8.14E|%- 8.14E|%-#8.14E|%-08.14E|%-+#8.14E|%-+ #08.14E", DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN

int		conv_cap_e_double_min_various_flags_combined_with_minus(void)
{
