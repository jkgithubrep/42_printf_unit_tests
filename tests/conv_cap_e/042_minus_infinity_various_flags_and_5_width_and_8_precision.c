...
# define ARGS "%5.8E|%-5.8E|%+5.8E|% 5.8E|%#5.8E|%05.8E", -INFINITY, -INFINITY, -INFINITY, -INFINITY, -INFINITY, -INFINITY

int		conv_cap_e_minus_infinity_various_flags_and_5_width_and_8_precision(void)
{
