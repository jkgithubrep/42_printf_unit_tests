...
# define ARGS "%-+8.14LE|%- 8.14LE|%-#8.14LE|%-08.14LE|%-+#8.14LE|%-+ #08.14LE", 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L

int		conv_cap_e_long_double_various_flags_combined_with_minus(void)
{
