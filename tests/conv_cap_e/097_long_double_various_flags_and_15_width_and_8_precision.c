...
# define ARGS "%15.8LE|%-15.8LE|%+15.8LE|% 15.8LE|%#15.8LE|%015.8LE", 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L

int		conv_cap_e_long_double_various_flags_and_15_width_and_8_precision(void)
{
