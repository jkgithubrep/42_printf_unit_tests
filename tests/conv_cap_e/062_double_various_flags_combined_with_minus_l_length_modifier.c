...
# define ARGS "%-+8.14lE|%- 8.14lE|%-#8.14lE|%-08.14lE|%-+#8.14lE|%-+ #08.14lE", 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849

int		conv_cap_e_double_various_flags_combined_with_minus_l_length_modifier(void)
{
