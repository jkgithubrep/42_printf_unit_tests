...
# define ARGS "%lE|%-lE|%+lE|% lE|%#lE|%0lE", 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849

int		conv_cap_e_double_various_flags_l_length_modifier(void)
{
