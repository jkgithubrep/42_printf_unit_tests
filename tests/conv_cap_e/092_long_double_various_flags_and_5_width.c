...
# define ARGS "%5LE|%-5LE|%+5LE|% 5LE|%#5LE|%05LE", 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L

int		conv_cap_e_long_double_various_flags_and_5_width(void)
{
