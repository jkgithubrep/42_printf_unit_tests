...
# define ARGS "%5.8LE|%-5.8LE|%+5.8LE|% 5.8LE|%#5.8LE|%05.8LE", 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L

int		conv_cap_e_long_double_various_flags_and_5_width_and_8_precision(void)
{
