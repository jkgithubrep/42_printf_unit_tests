...
# define ARGS "%15.8E|%-15.8E|%+15.8E|% 15.8E|%#15.8E|%015.8E", -INFINITY, -INFINITY, -INFINITY, -INFINITY, -INFINITY, -INFINITY

int		conv_cap_e_minus_infinity_various_flags_and_15_width_and_8_precision(void)
{
