...
# define ARGS "%5lE|%-5lE|%+5lE|% 5lE|%#5lE|%05lE", 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849

int		conv_cap_e_double_various_flags_and_5_width_l_length_modifier(void)
{
