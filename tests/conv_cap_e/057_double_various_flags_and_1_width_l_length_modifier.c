...
# define ARGS "%1lE|%-1lE|%+1lE|% 1lE|%#1lE|%01lE", 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849

int		conv_cap_e_double_various_flags_and_1_width_l_length_modifier(void)
{
