...
# define ARGS "%5.8lE|%-5.8lE|%+5.8lE|% 5.8lE|%#5.8lE|%05.8lE", 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849

int		conv_cap_e_double_various_flags_and_5_width_and_8_precision_l_length_modifier(void)
{
