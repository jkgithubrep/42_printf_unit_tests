...
# define ARGS "%15.8E|%-15.8E|%+15.8E|% 15.8E|%#15.8E|%015.8E", DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN, DBL_MIN

int		conv_cap_e_double_min_various_flags_and_15_width_and_8_precision(void)
{
