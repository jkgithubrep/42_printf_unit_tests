...
# define ARGS "%.8lE|%-.8lE|%+.8lE|% .8lE|%#.8lE|%0.8lE", 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849

int		conv_cap_e_double_various_flags_and_8_precision_l_length_modifier(void)
{
