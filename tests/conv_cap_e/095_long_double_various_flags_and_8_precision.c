...
# define ARGS "%.8LE|%-.8LE|%+.8LE|% .8LE|%#.8LE|%0.8LE", 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L, 12.847e451L

int		conv_cap_e_long_double_various_flags_and_8_precision(void)
{
