...
# define ARGS "%15.8E|%-15.8E|%+15.8E|% 15.8E|%#15.8E|%015.8E", DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX

int		conv_cap_e_double_max_various_flags_and_15_width_and_8_precision(void)
{
