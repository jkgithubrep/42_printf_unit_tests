...
# define ARGS "%+8.14E|%+ 8.14E|%+-8.14E|%+#8.14E|%+08.14E|%+ -#08.14E", -INFINITY, -INFINITY, -INFINITY, -INFINITY, -INFINITY, -INFINITY

int		conv_cap_e_minus_infinity_various_flags_combined_with_plus(void)
{
